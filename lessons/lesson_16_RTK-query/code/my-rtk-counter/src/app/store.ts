...
export const store = configureStore({
  ...
  // Берем стандартные middleware Redux Toolkit и добавляем RTK Query middleware.
  // Оно отвечает за кеширование и рефетчинг
  ...
  // "Возьми стандартные настройки Redux Toolkit и добавь к ним RTK Query механизм запросов"
  // Представьте:

...
const ApodPage = lazy(() => import('./features/apod/components/ApodPage'));
const ChristmasCountdown = lazy(
  () => import('./pages/ChristmasCountdown/ChristmasCountdown')
);
  ...
  return (
    <Layout>
      ...
      <Routes>
        ...
        <Route path='/christmas-countdown' element={<ChristmasCountdown />} />
        {/* 404 Route */}
        <Route
          path='*'
          element={

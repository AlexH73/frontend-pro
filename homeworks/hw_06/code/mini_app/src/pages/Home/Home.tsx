        ...
        <div className="col-12">
          <div className="jumbotron bg-light p-5 rounded">
            ...
            <p>
              ...
              Application) с использованием React, который демонстрирует работу
              с REST API через различные endpoint'ы JSONPlaceholder.
            </p>
            <p>
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="card-text">Альбомы фотографий пользователей.</p>
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p className="card-text">Фотографии из различных альбомов.</p>
